# -*- coding: utf-8 -*-
__title__ = "AKl-MAX-Template"                           # Name of the button displayed in Revit UI
__doc__ = """Version = 1.0
Date    = 19.10.2023
_____________________________________________________________________
Description:
This is a MAX template file for pyRevit Scripts.
_____________________________________________________________________
How-to:
-> Click on the button
...
_____________________________________________________________________
Last update:
- [19.10.2023] - 1.0 RELEASE
_____________________________________________________________________
To-Do:
- 
_____________________________________________________________________
Author: Adam Klosinski"""                                           # Button Description shown in Revit UI

# EXTRA: You can remove them.
__author__ = "Adam Klosinski"                                       # Script's Author
__helpurl__ = "http://ibim.pl"     # Link that can be opened with F1 when hovered over the tool in Revit UI.
...
if __name__ == '__main__':
    ...
    print('Template has been developed by Adam Klosinski.')